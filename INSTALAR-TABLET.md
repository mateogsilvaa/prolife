...
| «Vuelve a entrar en Google» | Google ha dado por terminado el permiso de la tablet. Pulsa el botón y ya está: no se pierde nada y la carpeta sigue elegida. La propia pantalla te dice lo que contestó Google. |
| «Vuelve a entrar en Google» **cada pocos días** | La pantalla de consentimiento se quedó en «Prueba», y ahí Google caduca el permiso **a los siete días**. En `console.cloud.google.com/auth/audience` → **Publicar la aplicación**. Es el paso 1.3, y es el único arreglo: mientras siga en prueba, volverá cada semana. |
| «Este aparato no está emparejado» **en la tablet** | Era un fallo de la app: ese cartel es del ordenador —habla de un enlace de emparejamiento que en el APK no existe— y salía cuando lo que pasaba de verdad era que la sesión de Google se había acabado. Arreglado; actualiza el APK (pasos 3 y 4) y te saldrá el botón de volver a entrar. |
